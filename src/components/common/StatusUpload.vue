...
<template>
  <div
    class="w-[360px] h-fit min-h-[360px] px-2 max-h-[360px] flex flex-row justify-center items-center gap-4 rounded-2xl overflow-hidden bg-white xl:w-[520px] xl:max-h-none xl:min-h-0 xl:h-fit"
  >
    ...
    <div
      class="w-full h-[310px] flex flex-col gap-2 rounded-xl border border-subtext border-opacity-25 overflow-y-scroll xl:overflow-visible xl:max-h-none xl:border-none xl:h-fit"
    >
