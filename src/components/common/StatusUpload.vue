...
<template>
  <div
    class="w-[360px] h-fit min-h-[360px] px-2 max-h-[360px] flex flex-col justify-center items-center gap-4 rounded-2xl overflow-hidden bg-white xl:w-[520px] xl:max-h-none xl:min-h-0 xl:h-fit"
  >
